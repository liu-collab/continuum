...
| `recall_accuracy_proxy`（召回准确率代理值） | > 80% | 0 / 3 = 0% | 未达标 |
...
| `knowledge_extraction_accuracy`（知识提取准确率） | > 85% | 0 / 2 = 0% | 未达标 |
| `governance_correctness_proxy`（治理正确率代理值） | > 85% | 1 / 2 = 50% | 未达标 |
...
|---|---|---|---|---|
| 召回准确率 | 人工标注样本中，最终召回是否正确帮助当前问题 | > 80% | 离线样本 0 / 3 = 0%，人工值未采集 | 待补人工标注 |
| 治理正确率 | 治理动作是否符合预期，没有误归档、误合并、误删除 | > 85% | 离线样本 1 / 2 = 50%，人工值未采集 | 待补人工标注 |
...
| 知识提取准确率 | 演化提取出的长期知识是否正确、可复用 | > 85% | 离线样本 0 / 2 = 0%，人工值未采集 | 待补人工标注 |
