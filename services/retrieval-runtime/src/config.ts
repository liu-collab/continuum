...
const envSchema = z.object({
  ...
  INJECTION_HARD_WINDOW_TURNS_FACT_PREFERENCE: z.coerce.number().int().min(0).default(5),
  ...
  INJECTION_HARD_WINDOW_MS_FACT_PREFERENCE: z.coerce.number().int().min(0).default(30 * 60 * 1000),
