    ...
    <div className="space-y-6">
      <div className="rounded-[28px] border bg-[linear-gradient(135deg,rgba(24,24,27,0.96),rgba(39,39,42,0.92))] px-6 py-7 text-white shadow-soft sm:px-8">
        <div className="max-w-3xl">
          <div className="text-[11px] font-medium uppercase tracking-[0.18em] text-white/60">{eyebrow}</div>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">{title}</h1>
          <p className="mt-3 text-sm leading-7 text-white/72 sm:text-base">{description}</p>
        </div>
      </div>
