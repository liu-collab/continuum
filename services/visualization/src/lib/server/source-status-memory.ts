...
declare global {
  var __AXIS_VIZ_LAST_OK_BY_SOURCE__: Map<string, string> | undefined;
}

function getLastOkMap() {
  if (!globalThis.__AXIS_VIZ_LAST_OK_BY_SOURCE__) {
    globalThis.__AXIS_VIZ_LAST_OK_BY_SOURCE__ = new Map<string, string>();
  }

  return globalThis.__AXIS_VIZ_LAST_OK_BY_SOURCE__;
}
