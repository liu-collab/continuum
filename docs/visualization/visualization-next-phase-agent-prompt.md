...
const mockRuntimeResponse = {
  ...
  trigger_runs: [{ trace_id: "t1", trigger_hit: true, trigger_type: "phase", trigger_reason: "before_response is mandatory", requested_memory_types: ["fact_preference"], scope_limit: ["user"], importance_threshold: 3, cooldown_applied: false, semantic_score: null, degraded: null, degradation_reason: null, duration_ms: 12, created_at: "2026-04-16T00:00:00Z" }],
