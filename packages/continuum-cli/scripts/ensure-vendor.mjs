...
const requiredPaths = [
  ...
  path.join(packageDir, "vendor", "memory-native-agent", "dist", "src", "session-store", "migrations", "0001-init.sql"),
  path.join(packageDir, "vendor", "memory-native-agent", "node_modules", "yaml"),
